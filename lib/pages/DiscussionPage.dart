...
class _DiscussionPageState extends State<DiscussionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<DiscussionResponse>(
        ...
        builder: (BuildContext context, AsyncSnapshot<DiscussionResponse> snapshot) {
          ...
          return _pageScaffold(title: L.GENERAL_LOADING, body: T.feedbackScreen(isLoading: true));
        });
  }
    ...
    return CupertinoPageScaffold(
      navigationBar: CupertinoNavigationBar(
          ...
          middle: Container(
              ...
              child: Text(title,
                  style: TextStyle(color: CupertinoTheme.of(context).textTheme.textStyle.color), overflow: TextOverflow.ellipsis))),
      child: body,
    );
  }
  ...
  Widget _createDiscussionPage(DiscussionResponse discussionResponse, DiscussionPageArguments pageArguments) {
    ...
    return _pageScaffold(title: discussionResponse.discussion.name.replaceAll('', '\u{200B}'), body: Stack(
      children: [
        PullToRefreshList(
