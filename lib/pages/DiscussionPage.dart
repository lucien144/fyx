                        ...
                        child: IntrinsicWidth(
                          child: Column(children: [
                            ...
                            if (discussionResponse.discussion.hasHeader)
                              GestureDetector(
                                onTap: () => Navigator.of(context)
                                    .pushNamed('/discussion/header', arguments: new DiscussionHomePageArguments(discussionResponse.discussion.idKlub)),
                                child: Row(
                                  children: [
                            ...
                            if (discussionResponse.discussion.hasHome)
                              GestureDetector(
                                onTap: () => Navigator.of(context)
                                    .pushNamed('/discussion/home', arguments: new DiscussionHomePageArguments(discussionResponse.discussion.idKlub)),
                                child: Row(
                                  children: [
